        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <Reveal className="mb-16 p-8 rounded-2xl bg-muted/50 border border-border text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Link to="/aciddyes" className="px-6 py-3 rounded-xl bg-white border border-border text-foreground hover:border-primary hover:text-primary shadow-soft transition-colors">
                Acid Dyes
              </Link>

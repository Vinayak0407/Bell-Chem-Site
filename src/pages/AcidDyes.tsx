...
>
  ...
  <div className="flex items-center space-x-2 mb-4">
    ...
    <h2 className="text-3xl font-bold text-white">Acid Dyes</h2>
  </div>

  <p className="text-xl text-white leading-relaxed mb-6">
    Specialized acid dyes for wool, silk, and nylon with excellent light fastness
    and leveling properties. Our acid dyes are formulated to provide superior
    performance in protein fiber applications.
  </p>

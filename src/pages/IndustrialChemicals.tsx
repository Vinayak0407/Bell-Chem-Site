        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <h2 className="text-3xl font-bold text-gray-900">Industrial Chemicals</h2>
            </div>
            <p className="text-lg text-gray-600 mb-6">
              High-grade chemicals for pharmaceutical, textile, and manufacturing applications 
              with strict quality control. Our industrial chemicals meet international standards 
              and are manufactured using cutting-edge technology.
            </p>
